...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
            $attackerpoint = $row['detector_points'] + 1;
            ...
            $updateQuery = "UPDATE attacks SET attacker_number = '$randomNumber1', defender_number = '$randomNumber2', detector_points = '$attackerpoint' WHERE attacker = '$attacker' AND defender = '$defender'";
